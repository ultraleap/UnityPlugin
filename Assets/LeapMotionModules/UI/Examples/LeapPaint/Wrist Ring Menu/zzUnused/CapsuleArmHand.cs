...
namespace Leap.Unity {
  ...
  public class CapsuleArmHand : IHandModel {
    ...
    private List<Renderer> _handRenderers;
    ...
    public override void InitHand() {
      ...
      _handRenderers = new List<Renderer>();
    ...
    private void updateArmVisibility() {
      ...
      for (int i = 0; i < _handRenderers.Count; i++) {
        _handRenderers[i].enabled = _showHand;
      }
    }
    ...
    private Transform createSphere(string name, float radius, bool isPartOfArm = false) {
      ...
      if (isPartOfArm) {
        ...
        _handRenderers.Add(sphere.GetComponent<Renderer>());
      }
    ...
    private void createCylinder(string name, Transform jointA, Transform jointB, bool isPartOfArm = false) {
      ...
      if (isPartOfArm) {
        ...
        _handRenderers.Add(cylinder.GetComponent<Renderer>());
      }
    }
