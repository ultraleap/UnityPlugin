...
namespace Leap.Unity.DetectionUtilities {
  [ExecuteInEditMode]
  public class PalmDirectionDetector : BinaryDetector {
    ...
    void OnDrawGizmos(){
      if(ShowGizmos && handModel != null){
        ...
        this.DrawCone(hand.PalmPosition.ToVector3(), hand.PalmNormal.ToVector3(), OnAngle, hand.PalmWidth, centerColor, 8);
        this.DrawCone(hand.PalmPosition.ToVector3(), hand.PalmNormal.ToVector3(), OffAngle, hand.PalmWidth, Color.blue, 8);
