    ...
    public static void Decode(ref VectorHand vectorHand, Hand toHand) {
      ...
      for (int fingerIdx = 0; fingerIdx < 5; fingerIdx++) {
        ...
        toHand.Fingers[fingerIdx].Fill(frameId:                -1,
                                       ...
                                       tipPosition:            ToWorld(nextJoint, palmPos, palmRot).ToVector(),
                                       tipVelocity:            Vector.Zero,
                                       direction:              (boneRot * Vector3.back).ToVector(),
                                       stabilizedTipPosition:  ToWorld(nextJoint, palmPos, palmRot).ToVector(),
                                       width:                  1f,
                                       length:                 1f,
                                       isExtended:             true,
      ...
      toHand.Fill(frameID:                -1,
                  ...
                  palmNormal:             (palmRot * Vector3.up).ToVector(),
