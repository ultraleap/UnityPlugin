...
namespace Leap.Unity.Animation {
  ...
  public struct CHS3 {
    ...
    /// </summary>
    public CHS3(Vector3 pos0, Vector3 pos1) {
      t0 = 0;
      t1 = 1;
    ...
    /// </summary>
    public CHS3(Vector3 pos0, Vector3 pos1, Vector3 vel0, Vector3 vel1) {
      t0 = 0;
      t1 = 1;
    ...
    /// </summary>
    public CHS3(Vector3 pos0, Vector3 pos1, Vector3 vel0, Vector3 vel1, float length) {
      t0 = 0;
      t1 = length;
    ...
    /// </summary>
    public CHS3(float t0, float t1, Vector3 pos0, Vector3 pos1, Vector3 vel0, Vector3 vel1) {
      this.t0 = 0;
      this.t1 = 1;
