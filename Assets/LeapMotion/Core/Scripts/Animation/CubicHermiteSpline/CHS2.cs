...
namespace Leap.Unity.Animation {
  ...
  public struct CHS2 {
    ...
    /// </summary>
    public CHS2(Vector2 pos0, Vector2 pos1) {
      t0 = 0;
      t1 = 1;
    ...
    /// </summary>
    public CHS2(Vector2 pos0, Vector2 pos1, Vector2 vel0, Vector2 vel1) {
      t0 = 0;
      t1 = 1;
    ...
    /// </summary>
    public CHS2(Vector2 pos0, Vector2 pos1, Vector2 vel0, Vector2 vel1, float length) {
      t0 = 0;
      t1 = length;
    ...
    /// </summary>
    public CHS2(float t0, float t1, Vector2 pos0, Vector2 pos1, Vector2 vel0, Vector2 vel1) {
      this.t0 = 0;
      this.t1 = 1;
