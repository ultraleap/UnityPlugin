...
namespace LeapCSharpWrapperTests
{
    ...
    public class LeapCTests
    {
        ...
        public void TestNow ()
        {
            ...
            Assert.Greater(delta, 500);
            Assert.Less(delta, 1500);
        }
...
//        }
        ...
        public void TestSetDeviceFlags ()
        {
            ...
            foreach(LEAP_DEVICE_REF deviceRef in deviceList){
                ...
                Assert.AreEqual((uint)eLeapDeviceFlag.eLeapDeviceFlag_Stream, priorFlags, "Device was streaming");
            }
        }
...
//            Assert.AreEqual(eLeapRS.eLeapRS_Success, result, "GetDeviceCount Call successful");
        ...
        public void TestInt32ConfigReadWrite ()
        {
            ...
            //Set to something
            UInt32 requestID = 5;
            result = LeapC.SaveConfigValue(connHandle, "tool_refinement_iterations", 2, out requestID);
            Assert.AreEqual(eLeapRS.eLeapRS_Success, result, "Config save requested");
            LEAP_CONNECTION_MESSAGE configMsg = new LEAP_CONNECTION_MESSAGE();
            ...
            //Read first
             requestID = 1;
            result = LeapC.RequestConfigValue(connHandle, "tool_refinement_iterations", out requestID);
            Assert.AreEqual(eLeapRS.eLeapRS_Success, result, "Config value requested");
             configMsg = new LEAP_CONNECTION_MESSAGE();
            ...
            Assert.AreEqual(2, response.value.intValue, "tool_refinement_iterations is 2, the default value");

            //Set to something else
            requestID = 5;
            result = LeapC.SaveConfigValue(connHandle, "tool_refinement_iterations", 6, out requestID);
            Assert.AreEqual(eLeapRS.eLeapRS_Success, result, "Config save requested");
            configMsg = new LEAP_CONNECTION_MESSAGE();
            ...
            Assert.AreEqual(6, response.value.intValue, "tool_refinement_iterations is 6, the changed value");
        }
        [Test()]
        ...
        public void TestStringConfigReadWrite ()
        {
            ...
            //Set to something
            UInt32 requestID = 5;
            result = LeapC.SaveConfigValue(connHandle, "quad_color", "PinkBlue", out requestID);
            Assert.AreEqual(eLeapRS.eLeapRS_Success, result, "Config save requested");
            LEAP_CONNECTION_MESSAGE configMsg = new LEAP_CONNECTION_MESSAGE();
            ...
            //Read first
            requestID = 1;
            result = LeapC.RequestConfigValue(connHandle, "quad_color", out requestID);
            Assert.AreEqual(eLeapRS.eLeapRS_Success, result, "Config value requested");
            configMsg = new LEAP_CONNECTION_MESSAGE();
            ...
            Assert.AreEqual("PinkBlue", response.value.stringValue, "Got PinkBlue.");

            //Set to something else
            requestID = 5;
            result = LeapC.SaveConfigValue(connHandle, "quad_color", "BluePink", out requestID);
            Assert.AreEqual(eLeapRS.eLeapRS_Success, result, "Config save requested");
            configMsg = new LEAP_CONNECTION_MESSAGE();
            ...
            Assert.AreEqual("BluePink", response.value.stringValue, "Got BluePink");
        }
