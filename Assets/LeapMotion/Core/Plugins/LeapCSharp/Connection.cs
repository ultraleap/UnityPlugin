...
namespace LeapInternal
{
  ...
  {
    private const string WORKER_THREAD_NAME = "Worker Thread";
    ...
    public static int countActiveStuff;
    ...
    ~Connection()
    {
      System.Threading.Interlocked.Decrement(ref countActiveStuff);
      Dispose(false);
    }

    private Connection(int connectionKey)
    {
      System.Threading.Interlocked.Increment(ref countActiveStuff);
    ...
    private void processMessages()
    {
      ...
      try
      {
        ...
        while (_isRunning)
        {
          ...
          {
            LeapBeginProfilingBlock(new BeginProfilingBlockArgs(POLL_CONNECTION_PROFILER_BLOCk));
          }
          ...
          {
            LeapEndProfilingBlock(new EndProfilingBlockArgs(POLL_CONNECTION_PROFILER_BLOCk));
          }
