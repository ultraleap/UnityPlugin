...
namespace LeapInternal {
  ...
  public class LeapC {
    ...
    [DllImport(LEAP_C, EntryPoint = "LeapGetConnectionInfo")]
    public static extern eLeapRS GetConnectionInfo(IntPtr hConnection, ref LEAP_CONNECTION_INFO pInfo);

    [DllImport(LEAP_C, EntryPoint = "LeapOpenConnection")]
    public static extern eLeapRS OpenConnection(IntPtr hConnection);

    [DllImport(LEAP_C, EntryPoint = "LeapSetAllocator")]
    public static extern eLeapRS SetAllocator(IntPtr hConnection, ref LEAP_ALLOCATOR pAllocator);

    [DllImport(LEAP_C, EntryPoint = "LeapGetDeviceList")]
    public static extern eLeapRS GetDeviceList(IntPtr hConnection,
      [In, Out] LEAP_DEVICE_REF[] pArray, out UInt32 pnArray);

    [DllImport(LEAP_C, EntryPoint = "LeapGetDeviceList")]
    private static extern eLeapRS GetDeviceList(IntPtr hConnection,
      [In, Out] IntPtr pArray, out UInt32 pnArray);
    ...
    [DllImport(LEAP_C, EntryPoint = "LeapRectilinearToPixel")]
    ...
    [DllImport(LEAP_C, EntryPoint = "LeapRectilinearToPixelEx")]
    ...
    [DllImport(LEAP_C, EntryPoint = "LeapGetPointMappingSize")]
    public static extern eLeapRS GetPointMappingSize(IntPtr hConnection, ref ulong pSize);

    [DllImport(LEAP_C, EntryPoint = "LeapGetPointMapping")]
