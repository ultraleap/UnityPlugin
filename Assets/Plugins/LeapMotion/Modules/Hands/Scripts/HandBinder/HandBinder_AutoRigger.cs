...
namespace Leap.Unity
{
    public static class HandBinder_AutoRigger
    {
        ...
        public static void AutoRig(ref HandBinder handBinder)
        {
        ...
        /// <returns></returns>
        public static bool IndexToType(int index, out Finger.FingerType fingerType, out Bone.BoneType boneType)
        {
            ...
            float combinedIndexWithDecimal = (index / 4.0f);
            float fingerIndex = Mathf.FloorToInt(combinedIndexWithDecimal);
            float decimalValue = combinedIndexWithDecimal - fingerIndex;
            float boneIndex = (int)(decimalValue * 4.0f);
            ...
            {
                fingerType = Finger.FingerType.TYPE_UNKNOWN;
                boneType = Bone.BoneType.TYPE_INVALID;
                return false;
            }
