...
namespace Leap.Unity
{
    public class HandBinder : HandModelBase
    {
        ...
        public HandBinder_BoneDefinitions customBoneDefinitions;
        ...
        public override void BeginHand() { base.BeginHand(); }
        public override Hand GetLeapHand() { return _leapHand; }
        public override void InitHand() { }
        public override void SetLeapHand(Hand hand) { _leapHand = hand; }
        public override bool SupportsEditorPersistence() { return false; }
        private void OnDestroy() { ResetHand(); }
        private void OnDisable() { ResetHand(); }
