...
{
    /// <summary>
    /// PhysicalHandsAnchorableBehaviours mix well with InteractionBehaviours you'd like to be able to
    ...
    public class PhysicalHandsAnchorableBehaviour : MonoBehaviour, IPhysicalHandContact, IPhysicalHandHover
    {
        ...
        //[Disable]
        [SerializeField]
        [Tooltip("Whether or not this PhysicalHandsAnchorableBehaviour is actively attached to its anchor.")]
        ...
        [Tooltip("The current anchor of this PhysicalHandsAnchorableBehaviour.")]
        [OnEditorChange("anchor"), SerializeField]
        private PhysicalHandsAnchor _anchor;
        public PhysicalHandsAnchor anchor
        {
            get
            {
                return _anchor;
        ...
        [Tooltip("The anchor group for this PhysicalHandsAnchorableBehaviour. If set to null, all Anchors "
               + "will be valid anchors for this object.")]
        [OnEditorChange("anchorGroup"), SerializeField]
        private PhysicalHandsAnchorGroup _anchorGroup;
        public PhysicalHandsAnchorGroup anchorGroup
        {
        ...
        [Tooltip("Should the object move smoothly towards the anchor at first, but lock to it once it reaches the anchor? "
               + "Note: Disabling the PhysicalHandsAnchorableBehaviour will stop the object from moving towards its anchor, and will "
        ...
        [Tooltip("While this object is moving smoothly towards its anchor, should it also inherit the motion of the "
               ...
               + "PhysicalHandsAnchorableBehaviour and prevent it from actually getting to the anchor.")]
        [DisableIf("lockToAnchor", isEqualTo: true)]
        ...
        [Tooltip("Should the PhysicalHandsAnchorableBehaviour automatically try to anchor itself when a grasp ends? If useTrajectory is enabled, "
        ...
        private PhysicalHandsAnchor _preferredAnchor = null;
        /// <summary>
        /// Gets the anchor this PhysicalHandsAnchorableBehaviour would most prefer to attach to.
        /// This value is refreshed every Update() during which the PhysicalHandsAnchorableBehaviour
        /// has no anchor or is detached from its current anchor.
        /// </summary>
        public PhysicalHandsAnchor preferredAnchor { get { return _preferredAnchor; } }

        #region Events

        /// <summary>
        /// Called when this PhysicalHandsAnchorableBehaviour attaches to an Anchor.
        /// </summary>
        public Action OnAttachedToAnchor = () => { };

        /// <summary>
        /// Called when this PhysicalHandsAnchorableBehaviour locks to an Anchor.
        /// </summary>
        public Action OnLockedToAnchor = () => { };

        /// <summary>
        /// Called when this PhysicalHandsAnchorableBehaviour detaches from an Anchor.
        /// </summary>
        public Action OnDetachedFromAnchor = () => { };

        /// <summary>
        /// Called during every Update() in which this PhysicalHandsAnchorableBehaviour is attached to an Anchor.
        /// </summary>
        public Action WhileAttachedToAnchor = () => { };

        /// <summary>
        /// Called during every Update() in which this PhysicalHandsAnchorableBehaviour is locked to an Anchor.
        /// </summary>
        ...
        /// </summary>
        public bool IsValidAnchor(PhysicalHandsAnchor anchor)
        {
            if (anchor == null)
            {
                return true;
        ...
        /// </summary>
        public bool IsWithinRange(PhysicalHandsAnchor anchor)
        {
        ...
        /// </summary>
        public PhysicalHandsAnchor FindPreferredAnchor()
        {
            if (!useTrajectory)
            {
            ...
            else
            {
                ...
                PhysicalHandsAnchor optimalAnchor = null;
                float optimalScore = 0F;
                PhysicalHandsAnchor testAnchor = null;
                float testScore = 0F;
        ...
        private List<PhysicalHandsAnchor> _nearbyAnchorsBuffer = new List<PhysicalHandsAnchor>();
        /// <summary>
        ...
        /// PhysicalHandsAnchorableBehaviour has no AnchorGroup.
        /// </summary>
        public List<PhysicalHandsAnchor> GetNearbyValidAnchors(bool requireAnchorHasSpace = true,
                                                  bool requireAnchorActiveAndEnabled = true)
        {
            HashSet<PhysicalHandsAnchor> anchorsToCheck;

            if (this.anchorGroup == null)
            {
                anchorsToCheck = PhysicalHandsAnchor.allAnchors;
            }
            else
            {
        ...
        /// an object to attach to it.
        ///
        /// Warning: This method checks squared-distance for all anchors in the scene if this PhysicalHandsAnchorableBehaviour
        /// has no AnchorGroup.
        /// </summary>
        public PhysicalHandsAnchor GetNearestValidAnchor(bool requireWithinRange = true,
                                            ...
                                            bool requireAnchorActiveAndEnabled = true)
        {
            ...
            PhysicalHandsAnchor closestAnchor = null;
        ...
        {
            PhysicalHandsAnchor preferredAnchor = FindPreferredAnchor();
        ...
        private void AttachToNearestAnchor(PhysicalHandsAnchor preferredAnchor)
        {
            if (preferredAnchor == null)
            {
        ...
        private float getAnchorScore(PhysicalHandsAnchor anchor)
        {
            return GetAnchorScore(_rigidbody.position,
                                  _rigidbody.velocity,
        ...
        {
            PhysicalHandsAnchor newPreferredAnchor;
            if (!isAttached)
            {
