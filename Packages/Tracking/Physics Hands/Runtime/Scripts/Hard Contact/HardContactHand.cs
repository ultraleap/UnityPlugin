    ...
    public class HardContactHand : ContactHand
    {
        ...
        internal override void BeginHand(Hand hand)
        {
            ...
            if(!resetting)
            {
                ...
                for (int i = 0; i < 32; i++)
                {
                    if (!Physics.GetIgnoreLayerCollision(physicsHandsManager.HandsLayer, i))
                    {
        ...
        private void ResetHardContactHand()
        {
            ...
            ghosted = true;
            ChangeHandLayer(physicsHandsManager.HandsResetLayer);
        ...
        private void HandleTeleportingHands()
        {
            ...
            {
                ChangeHandLayer(physicsHandsManager.HandsLayer);
