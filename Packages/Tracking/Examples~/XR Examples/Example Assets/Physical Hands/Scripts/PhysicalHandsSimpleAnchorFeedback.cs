...
namespace Leap.Unity.PhysicalHands
{
    ...
    [RequireComponent(typeof(Leap.Unity.PhysicalHands.PhysicalHandsAnchor))]
    [AddComponentMenu("")]
    public class PhysicalHandsSimpleAnchorFeedback : MonoBehaviour
    {

        public Transform scaleTarget;

        private Leap.Unity.PhysicalHands.PhysicalHandsAnchor _anchor;
        ...
        void Start()
        {
            _anchor = GetComponent<Leap.Unity.PhysicalHands.PhysicalHandsAnchor>();
