...
namespace Ultraleap.Tracking.OpenXR
{
    public class HandConfidenceFade : MonoBehaviour
    {
        ...
        private static readonly int ConfidenceIndex = Shader.PropertyToID("_Confidence");
        ...
        void Awake()
        {
            ...
            _renderer.material.SetFloat(ConfidenceIndex, 1.0f);
        }

        void OnUpdate()
        {
            _renderer.material.SetFloat(ConfidenceIndex, _handModel.GetLeapHand().Confidence);
        }
    }
}